      ...
      <div className='main'>
        ...
        <div className='intro'>
          <p>
            ...
            , which is a RESTful and GraphQL API based on the television show
            Rick and Morty. You will have access to about hundreds of
            characters, images, locations and episodes. The Rick and Morty API
        ...
        <footer className='footer'>
          <div className='about'>
            <p>
              This page was created as part of the React Workshop &copy; Roy
              Derks
            </p>
          </div>
          <div className='links'>
